...
CSV_FILE = 'Task03/data_ucb(-0.1)_patience30_lhc20_34.csv'
N_EVALS = 3
...
axes[0].plot(df['best_projected_pilot_Y'].values, color='steelblue', linestyle='--', linewidth=1, label='best projected pilot Y')
axes[0].set_ylabel('Y')
